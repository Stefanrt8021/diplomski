        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-secondary navbar-dark">
                ...
                <div class="navbar-nav w-100">
                    ...
                    $table_names = array();
                    foreach ($rezultat as $table) {
                        $table_names[] = $table->Tables_in_shop;
                    }
                    ...
                    <div class="col-12">
                        <div class="bg-secondary rounded h-100 p-4">
                            <div class="d-flex justify-content-between align-items-center mb-4">
                                ...
                                <h6 class="mb-4"><?=$_GET['tabela']; ?> </h6>
                                <button id="insertAdminPanel" class="insertBtn" data-name="<?= $_GET['tabela'] ?>">
                                    Insert
                                </button>
                            </div>
                            <div class="table-responsive">
                                <table class="table">
                                    ...
                                    <?php foreach ($result as $row): ?>
                                        <tr>
                                            ...
                                            <?php endforeach; ?>
                                            <td>
                                                <button id="deleteAdminPanel" class="deleteBtn" data-id="<?= $row->id ?>" data-name="<?=$table?>">
                                                    Delete
                                                </button>
                                            </td>
                                            <td>
                                                <button id="updateAdminPanel"  class="updateBtn" data-id="<?= $row->id ?>" data-name="<?=$table?>">
                                                    Update
                                                </button>
                                            </td>
                                ...
                                <div id="updateModal" class="modal">
                                    <div class="modal-content">
                                        <span class="centerHeading">Update</span>
                                ...
                                <div id="insertModal" class="modal">
                                    <div class="modal-content">
                                        <span class="centerHeading">Insert</span>
                                        <span class="close">&times;</span>
